    ...
    <div className="post-feed">
      <ul id="total-logout">
        {window.localStorage.getItem("stravaLogin") &&
          window.localStorage.getItem("spotifyLogin") &&
          renderTotalLogout()}
      </ul>
      {!(
        window.localStorage.getItem("stravaLogin") &&
        ...
        <ul id="logins">
          {window.localStorage.getItem("stravaLogin") ? (
            <li>
              <a href={redirect_uri} onClick={stravaLogout}>
                <button className="btn str-button">Strava Log-out</button>
              </a>
            </li>
          ) : (
            <li>
              <a href={authCodeLink} onClick={() => setIsLoading(true)}>
                <button className="btn str-button">Strava Log-in</button>
              </a>
              {isLoading && (
                <div id="spinner">
                  <ReactLoading
          ...
          {window.localStorage.getItem("stravaLogin") &&
            (window.localStorage.getItem("spotifyLogin") ? (
              <li>
                <a href={redirect_uri} onClick={spotifyLogout}>
              ...
              <li id="spot-login-li">
                <a href={spotAuthCodeLink} onClick={() => setIsLoading(true)}>
                  <button className="btn spotify-button">Spotify Log-in</button>
                </a>
                {isLoading && (
                  <div id="spinner">
                    <ReactLoading
      ...
      {window.localStorage.getItem("stravaLogin") && (
        ...
        >
          <img src={barButton} id="side-btn-image" alt="Sidebar Button"></img>
        </button>
      )}

      {!loggedIn && !spotLoggedIn && <TitleScreen />}
      <Post
